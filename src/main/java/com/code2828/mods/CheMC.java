...
public class CheMC implements ModInitializer {
  ...
  public static final Item Li_INGOT = new Item(
    new FabricItemSettings().group(ItemGroup.MATERIALS)
  );
  public static final SwordItem Li_SWORD = new SwordItem(
    MetalMaterials.SOFT_METAL,
    3,
    0.2F,
    new FabricItemSettings().group(ItemGroup.COMBAT).maxDamageIfAbsent(24)
  );
  public static final _PickaxeItem Li_PICKAXE = new _PickaxeItem(
    MetalMaterials.SOFT_METAL,
    2,
    0.15F,
    new FabricItemSettings().group(ItemGroup.TOOLS).maxDamageIfAbsent(24)
  );
  public static final _AxeItem Li_AXE = new _AxeItem(
    MetalMaterials.SOFT_METAL,
    4,
    0.1F,
    new FabricItemSettings().group(ItemGroup.TOOLS).maxDamageIfAbsent(24)
  );
  public static final _HoeItem Li_HOE = new _HoeItem(
    MetalMaterials.SOFT_METAL,
    1,
    0.6F,
    new FabricItemSettings().group(ItemGroup.TOOLS).maxDamageIfAbsent(24)
  );
  public static final ShovelItem Li_SHOVEL = new ShovelItem(
    MetalMaterials.SOFT_METAL,
    1,
    0.22F,
    new FabricItemSettings().group(ItemGroup.TOOLS).maxDamageIfAbsent(24)
  );
  public static final Item H2_GLASS = new Item(
    new FabricItemSettings().group(ItemGroup.MISC)
  );
  public static final Item HCl_GLASS = new Item(
    new FabricItemSettings().group(ItemGroup.MISC)
  );
  public static final Item N2_GLASS = new Item(
    new FabricItemSettings().group(ItemGroup.MISC)
  );
  public static final Item O2_GLASS = new Item(
    new FabricItemSettings().group(ItemGroup.MISC)
  );
  public static final Item Cl2_GLASS = new Item(
    new FabricItemSettings().group(ItemGroup.MISC)
  );
  public static final Item spodumene_DUST = new Item(
    new FabricItemSettings().group(ItemGroup.MISC)
  ); // LiAl[Si2O6], crafted with 1 nugget or by smelting a granite
  public static final Item spodumene_NUGGET = new Item(
    new FabricItemSettings().group(ItemGroup.MISC)
  ); // LiAl[Si2O6], dropped by an ore or crafted with 9 dusts
  public static final Item Zn_INGOT = new Item(
    new FabricItemSettings().group(ItemGroup.MISC)
  );
  public static final Item sphalerite_NUGGET = new Item(
    new FabricItemSettings().group(ItemGroup.MISC)
  ); //ZnS, dropped by an ore
  public static final Item lime_DUST = new Item(
    new FabricItemSettings().group(ItemGroup.MISC)
  ); // CaO, blasted from a stone (not cobblestone)
  public static final Item hydrated_lime_DUST = new Item(
    new FabricItemSettings().group(ItemGroup.MISC)
  ); // Ca(OH)2

  // hardness is from baike.baidu.com
  public static final Block Li_BLOCK = new Block(
    FabricBlockSettings.of(Material.METAL).strength(h2h(0.6))
  );
   ...
   */
  public static final Block spodumene_ORE = new Block(
    FabricBlockSettings.of(Material.STONE).strength(h2h(6.8))
  );
  public static final Block Zn_BLOCK = new Block(
    FabricBlockSettings.of(Material.METAL).strength(h2h(2.5))
  );
  public static final Block sphalerite_ORE = new Block(
    FabricBlockSettings.of(Material.STONE).strength(h2h(3.5))
  ); // ZnS, drops 7 sphalerite nuggets

  private static final ConfiguredFeature<?, ?> ORE_SPODUMENE_O = Feature.ORE
    .configure(
      new OreFeatureConfig(
        OreFeatureConfig.Rules.BASE_STONE_OVERWORLD,
        spodumene_ORE.getDefaultState(),
        2
      )
    ) // vein size
    .decorate(
  ...
  public void registerItem(String identifier, Item item_) {
    Registry.register(
      Registry.ITEM,
      new Identifier("chemc", identifier),
      item_
    );
  }
  ...
  public void registerBABI(String identifier, Block block_, ItemGroup gruop) { // Block And BlockItem; intended typo
    ...
    Registry.register(
      Registry.ITEM,
      new Identifier("chemc", identifier),
      new BlockItem(block_, new FabricItemSettings().group(gruop))
    );
  }

  @Override
  public void onInitialize() {
    RegistryKey<ConfiguredFeature<?, ?>> oreSpodumeneOv = RegistryKey.of(
      Registry.CONFIGURED_FEATURE_KEY,
      new Identifier("chemc", "ore_spodumene_ov")
    );
    Registry.register(
      BuiltinRegistries.CONFIGURED_FEATURE,
      oreSpodumeneOv.getValue(),
      ORE_SPODUMENE_O
    );
